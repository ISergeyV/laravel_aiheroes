                        ...
                        <div class="flex items-center justify-center h-20 w-20 mx-auto mb-6 bg-blue-100 rounded-full">
                            ...
                            <svg class="h-10 w-10 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.6-3.75M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                        </div>
                    ...
                    <div class="p-8 bg-slate-50 rounded-lg shadow-md">
                        <h3 class="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                            <svg class="h-7 w-7 text-blue-600 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19 14.5M12 14.5v5.714c0 .597.237 1.17.659 1.591L17.25 21M12 14.5c-.606 0-1.153.24-1.563.638L5 21M12 14.5v-5.714c0-.597-.237-1.17-.659-1.591L6.75 6.096M12 14.5c.606 0 1.153.24 1.563.638L19 21m-7-6.5v-5.714c0-.597.237-1.17.659-1.591L17.25 6.096"/>
                            </svg>
                            Drywall Services
                        </h3>
